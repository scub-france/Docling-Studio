...
Dans l'onglet **Doc**, l'activation du mode **chunk** déclenche une réponse **HTTP 404** côté front. Le mode chunk est donc inutilisable.

TODO: ajouter logs / capture / endpoint exact qui 404.
...
- [ ] TODO: étapes précises de reproduction (doc utilisé, séquence UI)
- [ ] TODO: identifier l'endpoint backend qui 404
- [ ] TODO: correctif + non-régression
